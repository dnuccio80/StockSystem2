...
import com.danucdev.stocksystem.data.dao.CourtDao
...
@Database(entities = [ClientEntity::class, ConcessionEntity::class, CurrentAccountEntity::class, TransactionEntity::class], version = 9)
